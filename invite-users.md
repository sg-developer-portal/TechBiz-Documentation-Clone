...
- Public officers using a [non-SE GSIB](glossary) devicewith a valid organisation email address such as <your_name>@<acronym for your agency>.gov.sg. can invite other public officers or vendors.
